      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead className="text-lg flex justify-end items-center">Duration</TableHead>
          </TableRow>
        </TableHeader>
              ...
              <TableCell>
                <Link href={`/companion/${id}`}>
                  <div className="flex items-center gap-2">
                    <div className="size-[72px] flex justify-center items-center rounded-lg mx-md:hidden" style={{ backgroundColor: getSubjectColor(subject) }}>
                      <Image
